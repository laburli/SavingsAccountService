...
public interface TransactionDao extends JpaRepository<Transaction, Integer> {
    ...
    @Query(value = "SELECT * FROM Transaction WHERE customer_id= :customerId and customer_account_number=:accNum and transaction_time between :startDate  and :endDate", nativeQuery = true)
